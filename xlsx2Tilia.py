...
file_name_string = 'data/inputTemplate.xlsx.xlsx'
...
def createTilia(bigLoopCounter):
    ...
    wb = load_workbook(filename='data/inputTemplate.xlsx', read_only=True, data_only=True)

    # use with pandas pd.read_excel
    file_name_string = 'data/inputTemplate.xlsx'
